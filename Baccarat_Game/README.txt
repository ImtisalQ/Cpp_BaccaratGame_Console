...
5. Since the aim is to have a sum close to 9, a sum of either 8 or 9 automatically qualifies as a win. This is called a Natural win. If in the rare case it happens with both banker and player simultaneously then it is a Draw.
